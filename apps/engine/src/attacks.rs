...
mod test {
    use crate::attacks::{
        compute_bishop_attacks, compute_rook_attacks, mask_bishop_attacks, mask_black_pawn_attacks,
        mask_king_attacks, mask_knight_attacks, mask_rook_attacks, mask_white_pawn_attacks,
    };

    #[test]
    fn white_pawn() {
        assert_eq!(mask_white_pawn_attacks(28), 0x0000002800000000); // e4
        assert_eq!(mask_white_pawn_attacks(31), 0x0000004000000000); // h4
        assert_eq!(mask_white_pawn_attacks(24), 0x0000000200000000); // a4
    }

    #[test]
    fn black_pawn() {
        assert_eq!(mask_black_pawn_attacks(36), 0x0000000028000000); // e5
        assert_eq!(mask_black_pawn_attacks(39), 0x0000000040000000); // h5
        assert_eq!(mask_black_pawn_attacks(32), 0x0000000002000000); // a5
    }

    #[test]
    fn knight() {
        assert_eq!(mask_knight_attacks(18), 0x0000000A1100110A); // c3
        assert_eq!(mask_knight_attacks(45), 0x5088008850000000); // f6
        assert_eq!(mask_knight_attacks(0), 0x0000000000020400); // a1
        assert_eq!(mask_knight_attacks(1), 0x0000000000050800); // b1
        assert_eq!(mask_knight_attacks(6), 0x0000000000A01000); // g1
        assert_eq!(mask_knight_attacks(7), 0x0000000000402000); // h1
        assert_eq!(mask_knight_attacks(22), 0x000000A0100010A0); // g3
        assert_eq!(mask_knight_attacks(41), 0x0508000805000000); // b6
    }

    #[test]
    fn king() {
        assert_eq!(mask_king_attacks(28), 0x0000003828380000); // e4
        assert_eq!(mask_king_attacks(6), 0x000000000000E0A0); // g1
        assert_eq!(mask_king_attacks(7), 0x000000000000C040); // h1
        assert_eq!(mask_king_attacks(57), 0x0507000000000000); // b8
        assert_eq!(mask_king_attacks(56), 0x0203000000000000); // a8
        assert_eq!(mask_king_attacks(31), 0x000000C040C00000); // h4
        assert_eq!(mask_king_attacks(24), 0x0000000302030000); // a4
    }
