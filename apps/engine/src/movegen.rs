...
mod test {
    ...
    fn perft_pos_3() -> Result<(), FENError> {
        let state = &mut State::try_from("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1")?;
    ...
    fn perft_pos_5() -> Result<(), FENError> {
        let state =
            &mut State::try_from("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8")?;
